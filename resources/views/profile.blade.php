  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="https://www.txdigitizing.com" target="_blank">User profile</a>
        <!-- Form -->
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>{{ $user->caddress }}
                </div>
                <div class="h5 mt-4">
  ...
  <footer class="footer">
    <div class="row align-items-center justify-content-xl-between">
      <div class="col-xl-6 m-auto text-center">
        <div class="copyright">
          <p>Made with <a href="https://www.txdigitizing.com" target="_blank">TX Digitizing</a> by Code Logic Solution</p>
        </div>
      </div>
    </div>
  </footer>
